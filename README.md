...
> **Currently on v0.5.0** — feature-complete for the milestone, install from source.
...
Feature-complete for the **v0.5.0** milestone, installable from source.
...
all work today, alongside the full 0.2–0.5.0 stack described below. **Not yet
...
`docs/version-0-4-2/`, `docs/version-0-4-3/`, and `docs/version-0-5/`.
