...
> per-group detail.
**Source documents:**
- Requirements Document v0.3 (`../emberly-code-requirements.md`) — WHAT/WHY
- Design Guideline v0.3 (`../emberly-code-design-guideline.md`) — UX/voice
- Technical Specification v0.1 (`../emberly-code-tech-spec.md`) — HOW
